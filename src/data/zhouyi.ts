// 《周易》卦爻辞为公有领域古籍原文。
// 数据结构参照 chinese-fortune/assets/64hex.json（MIT）并与 ctext.org 文本校核。
// Portions of the data structure: Copyright (c) 2026 chinese-fortune contributors.

export interface ZhouyiLineText {
  label: string
  text: string
}
...
const ZHOUYI_TEXTS = [
  ...
  {
    "statement": "元亨，利牝马之贞。君子有攸往，先迷后得主，利。西南得朋，东北丧朋。安贞吉。",
    "lines": [
      {
        "label": "初六",
        "text": "履霜，坚冰至。"
  ...
  {
    "statement": "亨。匪我求童蒙，童蒙求我。初筮告，再三渎，渎则不告。利贞。",
    "lines": [
      {
        "label": "初六",
  ...
  {
    "statement": "有孚窒惕，中吉，终凶。利见大人，不利涉大川。",
    "lines": [
      {
        "label": "初六",
        "text": "不永所事，小有言，终吉。"
  ...
  {
    "statement": "亨。出入无疾，朋来无咎。反复其道，七日来复，利有攸往。",
    "lines": [
      {
        "label": "初九",
        "text": "不远复，无祗悔，元吉。"
  ...
  {
    "statement": "有孚，元吉，无咎可贞，利有攸往。曷之用?二簋可用享。",
    "lines": [
      {
        "label": "初九",
        "text": "已事遄往，无咎，酌损之。"
  ...
  {
    "statement": "扬于王庭，孚号有厉。告自邑，不利即戎，利有攸往。",
    "lines": [
      {
        "label": "初九",
        "text": "壮于前趾，往不胜，为咎。"
  ...
  {
    "statement": "亨。王假有庙。利见大人，亨利贞。用大牲吉，利有攸往。",
    "lines": [
      {
        "label": "初六",
  ...
  {
    "statement": "改邑不改井，无丧无得，往来井井。汔至，亦未繘井，羸其瓶，凶。",
    "lines": [
      {
        "label": "初六",
        "text": "井泥不食，旧井无禽。"
  ...
  {
    "statement": "亨。震来虩虩，笑言哑哑。震惊百里，不丧匕鬯。",
    "lines": [
      {
        "label": "初九",
        "text": "震来虩虩，后笑言哑哑，吉。"
  ...
  {
    "statement": "艮其背，不获其身。行其庭，不见其人。无咎。",
    "lines": [
      {
        "label": "初六",
        "text": "艮其趾，无咎，利永贞。"
  ...
  {
    "statement": "亨，利贞。可小事，不可大事。飞鸟遗之音，不宜上宜下，大吉。",
    "lines": [
      {
        "label": "初六",
        "text": "飞鸟以凶。"
...
] as const satisfies readonly ZhouyiHexagramText[]

export function zhouyiTextByKingWen(kingWenNumber: number): ZhouyiHexagramText {
  const text = ZHOUYI_TEXTS[kingWenNumber - 1]
  if (!text) throw new Error(`no Zhouyi text for King Wen number ${kingWenNumber}`)
  return text
}
